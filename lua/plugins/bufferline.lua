return {
    ...
    opts = {
        options = {
            -- mode: "buffers" default or "tabs" (only show tabpages)
            mode = "buffers",
            -- style: bufferline.style_preset.default or bufferline.style_preset.minimal
            ...
            -- indicator (the little mark next to the active buffer)
            indicator = {
            ...
            -- offsets (sidebars like nvimtree)
            offsets = {
                {
                    filetype = "NvimTree",
